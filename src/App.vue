  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/barrage-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/barrage-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/barrage-solo-helper</a></dd>
      </dl>
